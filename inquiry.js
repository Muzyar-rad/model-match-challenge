        ...
        <body>
          <div class="container">
            <div class="column1 flex">
              <div class="nameTitle">
                <p class="name">Muzyar Rad</p>
                <p class="title">Software Engineer</p>
              </div>
              <div class="location">
                <i class="fa fa-map-marker" aria-hidden="true"></i>
                <div class="address">
                  <p class="street">3922 Acacia Street</p>
                  <p class="city">Irvine, CA</p>
                  <p class="zipcode">92606</p>
                </div>
              </div>
              <div class="github">
                <i class="fa fa-github" aria-hidden="true"></i>
                <p class="gitUrl">https://github.com/Muzyar-rad</p>
              </div>
              <div class="linkedin">
                <i class="fa fa-linkedin" aria-hidden="true"></i>
                <p class="linkedinUrl">https://www.linkedin.com/in/muzyar-rad/</p>
              </div>
            </div>
            <div class="column2 center">
              <p class="bio">
                I am Muzyar (Mazy) Rad. Full-stack web developer with BS in computer
                software engineering who is passionate about coding, learning and
                working with new technology and tools, solving problems and overcoming
                challenges.
              </p>
            </div>
          </div>
